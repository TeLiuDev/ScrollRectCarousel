...
/// Open TeVariableDimensionScrollListTest scene and see that there are 3 buttons, add/subtract items and refresh view for if you change 
/// ScrollRect setting
/// 
...
[Serializable]
public class testData : ScrollRectCarouselDataAbstract
{
    public int count;
    public string description;
    public bool? doClickedTransition;
    public int asyncOperationState;
}

public class TestCarouselController : MonoBehaviour, IScrollRectCarouselDataController
{
    [SerializeField]
    ...
    public void AddToList()
    {
        ...
        if (UnityEngine.Random.Range(0, 100) >= 50)
        {
            newData.description += "\nDifferent dimensions and still work and scroll";
        }
